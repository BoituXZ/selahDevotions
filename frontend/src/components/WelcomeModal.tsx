...
export default function WelcomeModal({ isOpen, onClose }: WelcomeModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-stone-900/50 dark:bg-stone-950/70 backdrop-blur-sm p-4">
            <div className="bg-amber-50/50 dark:bg-stone-900/95 backdrop-blur w-full max-w-lg rounded-2xl shadow-2xl p-8 border border-amber-100 dark:border-stone-800">
                {/* Header */}
                ...
                <div className="text-stone-700 dark:text-stone-300 leading-relaxed space-y-4 font-sans text-sm">
                    <p>
                    ...
                    <p>
                        ...
                        <a
                            href={COMMUNITY_LINK}
                            className="text-stone-900 dark:text-stone-100 underline hover:text-stone-600 dark:hover:text-stone-300 transition"
                            target="_blank"
                ...
                <button
                    onClick={onClose}
                    className="mt-6 w-full bg-stone-900 dark:bg-stone-50 text-white dark:text-stone-900 py-3 rounded-lg font-medium hover:bg-stone-800 dark:hover:bg-stone-200 transition shadow-lg hover:shadow-xl"
                >
                    Got it
                </button>
            </div>
